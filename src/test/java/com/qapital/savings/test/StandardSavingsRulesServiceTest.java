package com.qapital.savings.test;
...
public class  StandardSavingsRulesServiceTest {
    ...
    @MockBean
    StandardTransactionsService standardTransactionsService;
    ...
    protected static List<Transaction> createDummyTransactions(Long userId) {
